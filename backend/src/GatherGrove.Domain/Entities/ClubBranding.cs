...
/// <summary>
/// Represents white-label branding settings for an Unlimited tier club
/// </summary>
public class ClubBranding
{
    /// <summary>
    ...
    /// <summary>
    /// The club these branding settings belong to
    /// </summary>
    ...
    /// </summary>
    public bool HideGatherGroveBranding { get; set; } = false;
    ...
    /// <summary>
    /// Navigation property for the club these branding settings belong to
    /// </summary>
