...
public interface IScheduledReportRepository
{
    ...
    /// </summary>
    Task<List<Domain.Entities.ReportExecutionHistory>> GetReportExecutionHistoryAsync(string scheduleId, int limit);

    /// <summary>
    /// Get report execution statistics
    /// </summary>
    Task<ReportExecutionStatistics> GetReportExecutionStatisticsAsync(int clubId);
}