...
import MemberRetentionStrategiesPage from '../page';
...
describe('MemberRetentionStrategiesPage', () => {
  beforeEach(() => {
    jest.clearAllMocks();
  ...
  it('should render back to resources link', () => {
    render(<MemberRetentionStrategiesPage />);
  ...
  it('should render page content', () => {
    const { container } = render(<MemberRetentionStrategiesPage />);
