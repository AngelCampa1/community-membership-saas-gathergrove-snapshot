...
import CrisisManagementAndEmergencyPlanningPage from '../page';
...
describe('CrisisManagementAndEmergencyPlanningPage', () => {
  beforeEach(() => {
    jest.clearAllMocks();
  ...
  it('should render back to resources link', () => {
    render(<CrisisManagementAndEmergencyPlanningPage />);
  ...
  it('should render page content', () => {
    const { container } = render(<CrisisManagementAndEmergencyPlanningPage />);
