...
import DigitalCommunicationToolsPage from '../page';
...
describe('DigitalCommunicationToolsPage', () => {
  beforeEach(() => {
    jest.clearAllMocks();
  ...
  it('should render back to resources link', () => {
    render(<DigitalCommunicationToolsPage />);
  ...
  it('should render page content', () => {
    const { container } = render(<DigitalCommunicationToolsPage />);
