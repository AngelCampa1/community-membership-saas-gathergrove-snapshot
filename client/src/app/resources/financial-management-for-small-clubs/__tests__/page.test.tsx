...
import FinancialManagementForSmallClubsPage from '../page';
...
describe('FinancialManagementForSmallClubsPage', () => {
  beforeEach(() => {
    jest.clearAllMocks();
  ...
  it('should render back to resources link', () => {
    render(<FinancialManagementForSmallClubsPage />);
  ...
  it('should render page content', () => {
    const { container } = render(<FinancialManagementForSmallClubsPage />);
