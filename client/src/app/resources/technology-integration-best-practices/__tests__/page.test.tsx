...
import TechnologyIntegrationBestPracticesPage from '../page';
...
describe('TechnologyIntegrationBestPracticesPage', () => {
  beforeEach(() => {
    jest.clearAllMocks();
  ...
  it('should render back to resources link', () => {
    render(<TechnologyIntegrationBestPracticesPage />);
  ...
  it('should render page content', () => {
    const { container } = render(<TechnologyIntegrationBestPracticesPage />);
